bin/kafka-topics.sh --zookeeper zookeeper.internal.hippocamp.io:2181 --create --topic test-rep-one --partitions 6 --replication-factor 1
bin/kafka-topics.sh --zookeeper zookeeper.internal.hippocamp.io:2181 --create --topic test --partitions 6 --replication-factor 3
...
bin/kafktopics.sh --zookeeper zookeeper.internal.hippocamp.io:2181 --create --topic test --partitions 6 --replication-factor 3
bin/kafka-run-class.sh org.apache.kafka.clients.tools.ProducerPerformance test6 50000000 100 -1 acks=1 bootstrap.servers=kafka.internal.hippocamp.io:9092 buffer.memory=67108864 batch.size=8196
